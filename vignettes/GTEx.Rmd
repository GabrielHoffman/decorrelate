...
# Standard PCA
```{r PCA}
res.standard = prcomp(gtex_log2cpm, center=TRUE, scale=TRUE)


ggplot(res.standard, aes(PC1, PC2)) + geom_point() + theme_classic() + theme(aspect.ratio=1, plot.title = element_text(hjust = 0.5))



# decorrelate
```{r}
res.decorr = pca_cor2( gtex_log2cpm, 10, maxit=10)
