...
cp /hpc/users/hoffmg01/build2/decorrelate/vignettes/computational_scaling.html ~/www/software/decorrelate/
...
values = c(seq(100, 1200, length.out=50), seq(1000, 150000, length.out=50))
...
fig1 = fig + xlim(0, NA) + ylim(0, max(df_time$naive, na.rm=TRUE))
fig2 = fig + xlim(0, NA) + scale_y_log10()
