...
eval_runTime = function(df_values){
	df_time = lapply( 1:now(df_values), function(i){
		...
		data.frame(n = n, p = p, decorrelate = time_decorrelate, naive = time_naive)
	})
...
values = as.integer(sort(c(	seq(500, 8000, length.out=10))))

df_values = data.frame(n = 100, p = values)
