...
# values = c(	seq(500, 20000, length.out=50), 
# 			seq(25000, 150000, length.out=50),
# 			seq(200000, 1000000, length.out=10))

values = as.integer(sort(c(	seq(100, 8000, length.out=10))))
...
fig = ggplot(df_melt, aes(p, value, color=variable)) + geom_point() + theme_bw(16) + theme(aspect.ratio=1, plot.title = element_text(hjust = 0.5), legend.position="bottom") + xlab("Number of features") + ylab("Time in seconds") + geom_line(data=df_melt_p, aes(p, value, color=variable)) + scale_color_manual(name="Method", values = c("red", "blue", "green")) 
